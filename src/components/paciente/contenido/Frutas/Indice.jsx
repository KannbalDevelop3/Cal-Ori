...
const Indice = () => {
  ...
  const [traerDatosLlamado, setTraerDatosLlamado] = useState(false);
  ...
  const handleClick = (id) => {
    ...
    if (index < buttons.length - 1 && buttons[index].status === 'enabled') {
      const updatedElements = [...buttons];
      updatedElements[index + 1].status = 'enabled';
  ...
  // console.log('button0Enabled', button0Enabled);
  // console.log('date', date);
  // console.log('str_date', str_data);
  // console.log('exite', exite);
  return (
    <>
      <HorizontalPage>
        <BackgroundImageT backgroundImage={umage}>
          ...
          <div className='indicee__contenido-principal'>
            <div className='indicee__boton-siguiente'>
              <Link to='/paciente/menu-fruta-o-verdura'><img src={prevBoton} loading="lazy" /></Link>
            </div>
            <div className='indicee__boton-siguiente'>
