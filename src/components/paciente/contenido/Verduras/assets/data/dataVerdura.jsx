...
const menuverdura = [
    {
        ...
        subtema1: '',
        status: 'disabled',
        to: '/paciente/verduras/definicion'
    },
    {
        id: 2,
...
const menuBioactivo = [
    ...
    {
        id: 3,
        imagen: {img: biimg3, width: '90%'}

    }
]

export { menuverdura, menuclasificacion, envejecimientop, menuComposicion, menutermico, menuBioactivo }