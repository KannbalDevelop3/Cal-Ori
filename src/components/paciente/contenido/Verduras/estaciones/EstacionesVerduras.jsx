...
const EstacionesVerduras = () => {
    ...
    const ruta = '/paciente/verduras/reto-cinco'
    const rutaNext = '/paciente/verduras/reto-seis'
                        ...
                        {menuEstacionesVerduras.map(({ id, imagen, disabled, to }) => (
                            <div className='estaciones-verduras__center-div' key={id}>
                                <button className={`estaciones-verduras__boton-opt-e`}>
                                    <Link to={`${disabled === false ? `/paciente/verduras/estacion/${to}` : ''}`}>
...
export default EstacionesVerduras