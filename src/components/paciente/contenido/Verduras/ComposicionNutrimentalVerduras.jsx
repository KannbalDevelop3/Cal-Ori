...
const ComposicionNutrimentalVerduras = () => {
    ...
    return (
        <>
            <SlidePage
                ...
                rutaPrev='/paciente/verduras/reto-cuatro'
                rutaNext='/paciente/verduras/importancia-del-proceso-termico-de-las-verduras'
                to={toRoute}
            >
...
export default ComposicionNutrimentalVerduras