                ...
                <div className='opcion__grid'>
                    ...
                    <div className='opcion__menu-botones'>
                        {comestibles.map(comestible => (
                            <Link className='opcion__boton-link' key={comestible.id} to={`/profesionales/${comestible.comestible}`}><button className='opcion__boton-opt'><img src={comestible.imagen} loading="lazy" /></button></Link>
                        ))}
                    </div>
                </div>
                <div className='menu-verdura-o-fruta__boton-siguiente'>
                    <Link to='/profesionales'><img width='100%' src={prevBoton} loading="lazy" /></Link>
                </div>
            </BackgroundImageT>
        </>
    )
...
export default OpcionFrutasVerdurasPro
