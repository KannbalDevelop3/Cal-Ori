      ...
      <div className='procesamiento__menu-pdf'>
        ...
        <div className='procesamiento__contenido-principal'>
          <div className='procesamiento__boton-siguiente'>
            <Link to='/profesionales/frutas/reto-uno'><img src={prevBoton} loading="lazy" /></Link>
          </div>
          <div className='procesamiento__boton-siguiente'>
            <Link to='/profesionales/frutas/composicion-nutrimental' onClick={() => handleArrow()}>
