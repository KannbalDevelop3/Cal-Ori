...
const ComposicionNutrimientalPro = () => {
            ...
            <div className='composicion__contenedor'>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar ? `responsive__puntos pt__1` : `responsive__puntos pt__1a`} src={mostrarOcultar ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto()} />
                                            </td>
                                        ...
                                        <tr>
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar2 ? `responsive__puntos pt__2` : `responsive__puntos pt__2a`} src={mostrarOcultar2 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto2()} />
                                            </td>
                                            <td className='responsive__fila-textos'>
                                                <div className="responsive-fila-textos-centrar">
                                        ...
                                        <tr>
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar3 ? `responsive__puntos pt__3` : `responsive__puntos pt__3a`} src={mostrarOcultar3 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto3()} />
                                            </td>
                                            <td className='responsive__fila-textos'>
                                                <div className="responsive-fila-textos-centrar">
                                        ...
                                        <tr>
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar4 ? `responsive__puntos pt__4` : `responsive__puntos pt__4a`} src={mostrarOcultar4 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto4()} />
                                            </td>
                                            <td className='responsive__fila-textos'>
                                                <div className="responsive-fila-textos-centrar">
                                        ...
                                        <tr>
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar5 ? `responsive__puntos pt__5` : `responsive__puntos pt__5a`} src={mostrarOcultar5 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto5()} />
                                            </td>
                                            <td className='responsive__fila-textos'>
                                                <div className="responsive-fila-textos-centrar">
                                        ...
                                        <tr>
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar6 ? `responsive__puntos pt__6` : `responsive__puntos pt__6a`} src={mostrarOcultar6 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto6()} />
                                            </td>
                                            <td className='responsive__fila-textos'>
                                                <div className="responsive-fila-textos-centrar">
                                        ...
                                        <tr>
                                            <td className='responsive__fila-puntos'>
                                                <img className={mostrarOcultar7 ? `responsive__puntos pt__7` : `responsive__puntos pt__7a`} src={mostrarOcultar7 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto7()} />
                                            </td>
                                            <td className='responsive__fila-textos'>
                                                <div className="responsive-fila-textos-centrar">
                                ...
                                <div className='composicion__contenedor-doctor'>
                                    ...
                                    <div className='composicion__doctor_2'>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-1'} src={mostrarOcultar ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto()} />
                                        </div>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-2'} src={mostrarOcultar2 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto2()} />
                                        </div>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-3'} src={mostrarOcultar3 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto3()} />
                                        </div>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-4'} src={mostrarOcultar4 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto4()} />
                                        </div>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-5'} src={mostrarOcultar5 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto5()} />
                                        </div>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-6'} src={mostrarOcultar6 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto6()} />
                                        </div>
                                        <div className='doctor__boton'>
                                            <img className={'doctor__btn-azul btn__estado-7'} src={mostrarOcultar7 ? puntorosa : puntoazul} loading="lazy" onClick={() => mostrarTexto7()} />
                                        </div>
                                    </div>
                ...
                <div className='video__contenido-principal'>
                    <div className='video__boton-siguiente'>
                        <Link to='/profesionales/frutas/pdf'><img src={prevBoton} loading="lazy" /></Link>
                    </div>
                    <div className='video__boton-siguiente'>
                        <Link to='/profesionales/frutas/reto-dos' onClick={() => handleArrow()}>
                            <img src={sigBoton} />
                        </Link>
                    </div>
                </div>
                <ButtonRef onClick={handleModal}></ButtonRef>
                ...
                >
                    <TextBibliografia>
                        1. DeMan J, Finley J, Hurst W, Lee C. Principles of food chemistry. 4ª ed. Nueva York: Springer; 2018.
                    </TextBibliografia>
                    <TextBibliografia>
                        2. George N, Andersson AAM, Andersson R, Kamal-Eldin A. Lignin is the main determinant of total dietary fiber differences between date fruit (Phoenix dactylifera L.) varieties. NFS Journal. 2020;21:16-21.
                    </TextBibliografia>
                </ModalReferencias>}
            </div>
        </HorizontalPage>
...
export default ComposicionNutrimientalPro