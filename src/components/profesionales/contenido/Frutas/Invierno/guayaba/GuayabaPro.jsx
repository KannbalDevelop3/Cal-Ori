...
import modalfondo from './images/Modal_GUAYABA.png'
import fondoOverlay from '../assets/images/Fondo_modal.png'
import prev from './images/boton_guayaba_anterior.png'
import next from './images/boton_guayaba_siguiente.png'
import './css/guayaba.css'
import './css/guayabaindex.css'
import Slider from "../../../../../Reutilizable/Slider/Slider";
import GuayabaIndex from "./GuayabaIndex";
...
const GuayabaPro = (e) => {
    ...
    return (
        <>
            <HorizontalPage>
                <div className="fondo__guayaba">
                    <div className="guayaba__absolute-1 fade-in-image">
                        <Link className='frutas__link' to='/profesionales/frutas/estacion/invierno'>
                            <img src={flecha} loading="lazy" />
                        </Link>
                    </div>
                    <div className="guayaba__absolute-2 fade-in-image">
                        <img src={informacion} onClick={() => setEstado(!estado)} loading="lazy" />
                    </div>
                    <div className="guayaba__seccion-centrar">
                    ...
                    <div className="guayaba__botones-filter">
            ...
            <ModalCarousel estado={estado} cambiarEstado={setEstado} mostrarFondo={fondoOverlay} padding='10' >
                ...
                >
                    <TextBibliografia>
                        1. Gutiérrez RMP, Mitchell S, Solis RV. Psidium guajava: A review of its traditional uses, phytochemistry and pharmacology. Journal of Ethnopharmacology. 2008 Apr;117(1):1–27.
                    </TextBibliografia>
                </ModalReferencias>}
            </ModalCarousel>
        </>
