...
import modalfondo from './images/Modal_PERA.png'
import fondoOverlay from '../assets/images/Fondo_modal.png'
import prev from './images/boton_pera_anterior.png'
import next from './images/boton_pera_siguiente.png'
import './css/pera.css'
import PeraIndex from "./PeraIndex";
    ...
    <>
      <HorizontalPage>
        <div className="fondo__pera">
          ...
          <div className="pera__botones-filter">
      ...
      <ModalCarousel estado={estado} cambiarEstado={setEstado} mostrarFondo={fondoOverlay} padding='10' >
        ...
        >
          <TextBibliografia>
            1. Aguayo Rojas J, Mora Rochín S, Tovar Jiménez X, Rochín Medina JJ, Navarro Cortez RO. Fitoquímicos y propiedades nutraceúticas de durazno (Prunus persica L.) cultivado en Zacatecas. Polibotánica. 2022 Jan 15;0(53).
          </TextBibliografia>
        </ModalReferencias>}
      </ModalCarousel>
    </>
