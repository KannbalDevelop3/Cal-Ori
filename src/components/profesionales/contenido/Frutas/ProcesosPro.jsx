        ...
        <HorizontalPage>
            ...
            <div className='video__contenido-principal'>
                <div className='video__boton-siguiente'>
                    <Link to='/profesionales/frutas/video'><img src={prevBoton} loading="lazy" /></Link>
                </div>
                <div className='video__boton-siguiente'>
                    <Link to='/profesionales/frutas/reto-uno' onClick={() => handleArrow()}>
            ...
            {modal && <ModalReferencias setModal={setModal}
                ...
                mostrarOverlay={true}
            >
                <TextBibliografia>1. Galanakis C. Food Bioactives and Health. Suiza: Springer Cham; 2021. 378 p.</TextBibliografia>
                <TextBibliografia>2. Martínez-González M, Balois Morales R, Alia-Tejacal I, Cortes-Cruz M, Palomino-Hermosillo Y, López-Gúzman G. Poscosecha de frutos: maduración
                    y cambios bioquímicos. Revista Mexicana de Ciencias Agrícolas. 2017;1(19).
                </TextBibliografia>
            </ModalReferencias>}
        </div>
        </HorizontalPage>
