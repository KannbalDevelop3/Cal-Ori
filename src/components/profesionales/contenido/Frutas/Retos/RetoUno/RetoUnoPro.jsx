...
const RetoUnoPro = () => {
    ...
    const rutasig = '/profesionales/frutas/pdf';
    const ebook_Frutas = 'ebook_Frutas'
    const rutaPrev = '/profesionales/frutas/procesos'
    ...
    }, [str_data, traerDatosRetosFrutas]);  // volver a ejecutar solo si el arreglo cambia
    useEffect(() => {
        setStateReto(stateReto)
    }, [stateReto])
