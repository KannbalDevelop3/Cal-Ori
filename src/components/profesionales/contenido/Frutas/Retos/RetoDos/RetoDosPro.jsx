...
const RetoDosPro = () => {
    ...
    const rutasig = '/profesionales/frutas/estacion';
    const ebook_Frutas = 'ebook_Frutas'
    const rutaPrev = '/profesionales/frutas/composicion-nutrimental'
    ...
    console.log(stateReto, trofeoGameTwoFruta);
    return (
        <BackGameRows
            ...
            {stateReto === 0 ?
                ...
                : stateReto === 1 ?
                    ...
                    : stateReto === 2 ?
                        ...
                        >
                            <BotonCerrar>
                                <Link to='/profesionales/frutas/estacion' className='reset-link'>
