...
const RetoTres = () => {
    ...
    const rutasig = '/profesionales/frutas/conclusiones';
    const ebook_Frutas = 'ebook_Frutas'
    const rutaPrev = '/profesionales/frutas/estacion'
    ...
    console.log(stateReto, trofeoGameTreeFruta);
    return (
        <BackGameRows
                ...
                stateReto === 0 ?
                    ...
                    : stateReto === 1 ?
                        ...
                        : stateReto === 2 ?
                            ...
                            >
                                <BotonCerrar>
                                    <Link to='/profesionales/frutas/conclusiones' className='reset-link'>
