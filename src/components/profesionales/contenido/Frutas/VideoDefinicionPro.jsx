                ...
                <div className='video__contenido-vid'>
                    ...
                    <div className='video__contenido-principal'>
                        <div className='video__boton-siguiente'>
                            <Link to='/profesionales/frutas'><img src={prevBoton} loading="lazy" /></Link>
                        </div>
                        <div className='video__boton-siguiente'>
                            <Link to='/profesionales/frutas/procesos' onClick={() => handleArrow()}>
...
export default VideoDefinicionPro