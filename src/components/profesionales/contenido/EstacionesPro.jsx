...
const EstacionesPro = () => {
    ...
    const [frutPrim, setfrutPrim] = useState(false)
    const [frutVer, setfruVer] = useState(false)
    const [frutInv, setfrutInv] = useState(false)
                ...
                <div className='estaciones__grid-separador'>
                        ...
                        {buttons.map(({ id, imagen, disabled, to, status }) => (
                            <div className='estaciones__center-div' key={id}>
                                <button className={`estaciones__boton-opt-e`}>
                                    <Link
                                        to={`${disabled === false ? `/profesionales/frutas/estacion/${to}` : ''}`}
                                    >
                                        <img
                    ...
                    <div className='estaciones__buton-flecha'>
                        <div className='estaciones__boton-siguiente'>
                            <Link to="/profesionales/frutas/reto-dos"><img src={sigBoton} loading="lazy" /></Link>
                        </div>
                        <div className='estaciones__boton-siguiente'>
                            {
                                visibilityArrow === true ?
                                    (
                                        <Link to="/profesionales/frutas/reto-tres" onClick={() => handleArrow()}>
