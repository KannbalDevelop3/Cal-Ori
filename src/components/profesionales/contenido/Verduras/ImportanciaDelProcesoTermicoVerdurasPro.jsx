...
const ImportanciaDelProcesoTermicoVerdurasPro = () => {
    ...
    return (
        <>
            <SlidePage
                ...
                rutaPrev='/profesionales/verduras/composicion-nutrimental-de-verduras'
                rutaNext='/profesionales/verduras/bioactivos-presentes-en-las-verduras' height='auto'
                positionCF='relative'
...
export default ImportanciaDelProcesoTermicoVerdurasPro