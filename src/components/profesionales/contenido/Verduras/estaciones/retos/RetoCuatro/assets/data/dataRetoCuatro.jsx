...
const questions = [
    ...
    },
    {
        ...
        fruit: c2,
        trueFalse: [
            { isCorrect: true, answerText: v2, acert: check, noAcert: '' },
            { isCorrect: false, answerText: f2, acert: '', noAcert: noacert },
        ],
        retroMal: retroM2,
        retroBien: retroB2
    },
    {
        ...
        fruit: c3,
        trueFalse: [
            { isCorrect: true, answerText: v3, acert: check, noAcert: '' },
            { isCorrect: false, answerText: f3, acert: '', noAcert: noacert },
        ],
        retroMal: retroM3,
        retroBien: retroB3
    },
    ...
    },
    {
        ...
        fruit: c6,
        trueFalse: [
            { isCorrect: false, answerText: v6, acert: check, noAcert: ''},
            { isCorrect: true, answerText: f6, acert: '', noAcert: noacert },
        ],
        retroMal: retroM6,
        retroBien: retroB6
    },
