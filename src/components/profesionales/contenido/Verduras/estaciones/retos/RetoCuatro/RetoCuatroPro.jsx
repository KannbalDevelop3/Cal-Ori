...
export const RetoCuatroPro = () => {
    ...
    const rutasig = '/profesionales/verduras/composicion-nutrimental-de-verduras';
    const rutaPrev = '/profesionales/verduras/envejecimiento'
