          ...
          <FinishTime mostrarOverlay={true} backgroundDesktop={modalfinishTime}>
              ...
              <BotonResetGame
                onClick={() => {
                  ...
                  if (currentQuestion === questions.length - 1) {
                    ...
                    setModalCorrecto(false)
                    setModalIncorrect(false)
                    window.location.href = "/profesionales/verduras/reto-cuatro";
                  }
                }}
            ...
            <div>
              <BotonLinkGame marginTopLinkGame='10rem'>
                <Link to='/profesionales/verduras/composicion-nutrimental-de-verduras' className='reset-link' ><img src={btnContinuar} alt="" /></Link>
              </BotonLinkGame>
            </div>
          </FinishTime>
        }
