...
const RetoSeisPro = () => {
    ...
    const rutasig = '/profesionales/verduras/conclusiones';
    const rutaPrev = '/profesionales/verduras/estacion';
                ...
                stateReto === 0 ?
                    ...
                    : stateReto === 1 ?
                        ...
                        : stateReto === 2 ?
                            ...
                            >
                                <BotonCerrar>
                                    <Link to='/profesionales/verduras/conclusiones' className='reset-link-seis'>
