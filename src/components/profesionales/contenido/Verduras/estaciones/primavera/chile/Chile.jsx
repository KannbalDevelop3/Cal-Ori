...
import fondo from '../chile/assets/images/FONDO.jpg'
...
import ChileIndex from './ChileIndex';
import { datamch } from '../chile/ChileDias'
...
const ChilePro = () => {
    ...
    }, [contador, datamch.length]);

    if (!datamch || !datamch.length) return null;
    return (
        <>
            <ContenedorFV backgroundDesktop={fondo} rutaPrev={ruta} positionE='relative' cambiarEstadoo={abrirModal} estado={estado}  >
                ...
                />
                <FilterDiasContainer>
                    <FilterDias backgroundColor='#262e29' >
            ...
            <ModalCarousel estado={estado} cambiarEstado={cerrarModal} mostrarFondo={fondoOverlay} padding='10' top='10%' >
                <CaroselFlex backgrounddModal={modalfondo} className='fadein animation-linear animation-duration-1000'>
                    ...
                    <CaroselButtonsContainer className="buttons">
                        ...
                        <CaroselButtons id="nextBtn" onClick={handleRightClick} style={{ display: contador === datamch.length - 1 ? 'none' : 'block' }}>
                ...
                >
                    <TextBibliografia>
                        1. Wang, X., Ouyang, Y., Liu, J., Zhu, M., Zhao, G., Bao, W. y Hu, F.B. 2014. Fruit and vegetable consumption and mortality from all causes, cardiovascular disease, and cancer: Systematic review and dose- response meta-analysis of prospective cohort studies. Bmj 349: g4490. doi. org/10.1136/bmj.g4490.
                    </TextBibliografia>
                </ModalReferencias>}
            </ModalCarousel>
        </>
